...
public class GroupDataGenerator {
	...
	public static void main(String[] args) throws IOException {
		if(args.length<3){
			System.out.println("Please specify parametrs: <amount of tast data> <file> <format>");
			return;
		}
		...
		List<GroupData> groups = ganerateRandomGroups(amount);
	...
	public static List<GroupData> ganerateRandomGroups(int amount) {
		List<GroupData> list = new ArrayList<GroupData>();
